    ...
    public class CelestialOrbitDetails : ModSystem
    {
        ...
        public static float WorldSpecificAngularOffset
        {
            get
            {
                ...
                return Lerp(-TwoPi * 200f, TwoPi * 200f, RandomFloat(ref seed));
            }
        }
        ...
        public static bool WouldEclipseHappenAtDay(float fractionalDayCounter, out float distanceBetweenNoxusAndSun)
        {
            ...
            Vector2 sunPosition = NoxusSkySceneSystem.GetSunPosition(NoxusSkySceneSystem.PreviousSceneDetails, GetLerpValue(0.1875f, 0.8125f, DayCompletion, true));
        ...
        public override void PreUpdateWorld()
        {
            ...
            DayCompletion = GetDayTimeAs24FloatStartingFromMidnight() / 24f;
        }
