...
namespace NoxusBossMod.Content.Particles
{
    public class NoxusFumesIllusionParticle : Particle
    {
        ...
        public override string Texture => "NoxusBossMod/Content/Particles/NoxusFumesYharimIllusion";
        ...
        public override void CustomDraw(SpriteBatch spriteBatch)
        {
            ...
            if (Variant == 1)
                texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Particles/NoxusFumesCalamitasIllusion").Value;
            if (Variant == 2)
                texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Particles/NoxusFumesDraedonIllusion").Value;
            if (Variant == 3)
                texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Particles/LaRugaIllusion").Value;
