...
namespace NoxusBossMod.Content.Projectiles.Pets
{
    public class BabyNoxus : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // Simple floating pet AI replacement - offset to the side of the player
            Vector2 targetPosition = Owner.Center + new Vector2(Owner.direction * -80f, -50f);
            float speed = 0.15f;
            Projectile.velocity = (Projectile.velocity * 20f + (targetPosition - Projectile.Center)) / 21f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D handTexture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Projectiles/Pets/BabyNoxusHand").Value;
        ...
        {
            Texture2D backTexture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Projectiles/Pets/BabyNoxusBack").Value;
