...
namespace NoxusBossMod.Content.Bosses
{
    ...
    public class NoxusSky : CustomSky
    {
        ...
        public static float SkyIntensityOverride { get; set; }
        public static Vector2 FlashNoiseOffset { get; private set; }
        public static Vector2 FlashPosition { get; private set; }
        public static Color FogColor => new(49, 40, 70);
        public static readonly SoundStyle ThunderSound = new SoundStyle("NoxusBossMod/Assets/Sounds/Custom/ThunderRumble", 3) { Volume = 0.32f, PitchVariance = 0.35f };
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (Main.gfxQuality >= 0.6f)
            {
                ...
                DrawBackground(Color.Lerp(Color.MidnightBlue, Color.Pink, 0.3f), 2f, 1f, 1f, ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/GreyscaleTextures/TurbulentNoise"));
        ...
        public void DrawBackground(Color color, float localIntensity = 1f, float scrollSpeed = 1f, float noiseZoom = 1f, Asset<Texture2D> texture = null)
        {
            ...
            var backgroundShader = GameShaders.Misc[$"{NoxusBossMod.Instance.Name}:NoxusBackgroundShader"];
            ...
            backgroundShader.SetShaderTexture(ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/GreyscaleTextures/WavyBlotchNoise"), 2);
        ...
        public void DrawFog()
        {
            ...
            var backgroundShader = GameShaders.Misc[$"{NoxusBossMod.Instance.Name}:DarkFogShader"];
        ...
        public void DrawRubble(float minDepth, float maxDepth)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Bosses/BackgroundRubble").Value;
