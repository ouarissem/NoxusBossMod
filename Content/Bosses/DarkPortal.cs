...
namespace NoxusBossMod.Content.Bosses
{
    public class DarkPortal : ModProjectile, IDrawsWithShader
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            gd.Textures[1] = ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/GreyscaleTextures/StarDistanceLookup").Value;
            gd.Textures[2] = ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/GreyscaleTextures/TurbulentNoise").Value;
            gd.Textures[3] = ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/Void").Value;
            gd.Textures[4] = ModContent.Request<Texture2D>("Terraria/Images/Misc/Perlin").Value;
            gd.Textures[5] = ModContent.Request<Texture2D>("NoxusBossMod/Assets/ExtraTextures/GreyscaleTextures/Spikes").Value;
