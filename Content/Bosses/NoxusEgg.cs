...
using static NoxusBossMod.Content.Bosses.EntropicGod;
...
namespace NoxusBossMod.Content.Bosses
{
    ...
    public class NoxusEgg : ModNPC
    {
        ...
        public static readonly SoundStyle HitSound = new SoundStyle("NoxusBossMod/Assets/Sounds/NPCHit/NoxusEggHurt") { PitchVariance = 0.4f, Volume = 0.5f };
        public static readonly SoundStyle GlitchSound = new SoundStyle("NoxusBossMod/Assets/Sounds/Custom/NoxusGlitch") { PitchVariance = 0.2f, Volume = 1.3f, MaxInstances = 8 };
        ...
        public static void ClearAllProjectiles()
        {
            List<int> projectileTypesToDelete = new()
            {
                ...
                ModContent.ProjectileType<DistortionField>(),
            };
        ...
        {
            Texture2D backTexture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Bosses/NoxusBack").Value;
            Texture2D shellPiece1Texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Bosses/NoxusEggShell1").Value;
            Texture2D shellPiece2Texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Bosses/NoxusEggShell2").Value;
            Texture2D shellPiece3Texture = ModContent.Request<Texture2D>("NoxusBossMod/Content/Bosses/NoxusEggShell3").Value;
