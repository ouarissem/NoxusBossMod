...
namespace NoxusBossMod.Content.Tiles
{
    public class NoxusRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "NoxusBossMod/Content/Tiles/NoxusRelicTile";
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, ModContent.ItemType<NoxusRelic>());
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            for (float offsetAngle = 0f; offsetAngle < 1f; offsetAngle += 0.1666f)
                spriteBatch.Draw(texture, drawPos + (TwoPi * offsetAngle).ToRotationVector2() * (6f + offset * 2f), frame, effectColor, 0f, origin, 1f, effects, 0f);
        }
    }
}
