...
using NoxusBossMod.Content.Projectiles.Pets;
...
namespace NoxusBossMod.Core.Graphics
{
    public class PitchBlackMetaball : Metaball
    {
        ...
        {
            ModContent.Request<Texture2D>("NoxusBossMod/Core/Graphics/Metaballs/PitchBlackLayer")
        };
        ...
        {
            Texture2D circle = ModContent.Request<Texture2D>("NoxusBossMod/Core/Graphics/Metaballs/BasicCircle").Value;
            foreach (GasParticle particle in GasParticles)
